						...
						<div class="inside">
							<table class="form-table">
								<tbody>
									<tr>
										<td>
											<p><?php _e('Boost design and best solution for your website.', 'wp-slick-slider-and-image-carousel'); ?></p> <br/>											
											<a class="button button-primary button-orange" href="<?php echo WPSISAC_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Slickslider&utm_campaign=check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'wp-slick-slider-and-image-carousel'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPSISAC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Slickslider&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium ', 'wp-slick-slider-and-image-carousel'); ?></a>
							<p><a class="button button-primary wpos-button-full" href="https://demo.essentialplugin.com/prodemo/pro-wp-slick-slider-and-carousel-demo/" target="_blank"><?php _e('View PRO Demo ', 'wp-slick-slider-and-image-carousel'); ?></a></p>
						</div>
					</div>
				</div>
			</div>
